// Framework-free tests for the browser-side attribution capture and HubSpot identify.
//
...
// `npm test`. They mock the browser globals the modules touch (cookies, sessionStorage, the
// GTM dataLayer, the HubSpot `_hsq` queue) and assert the observable payload, since the real
// cookies and HubSpot round trip only exist in a live browser.
...
function resetBrowser() {
  ...
  globalThis.document = { get cookie() { return cookies.join('; '); } };
