...
import {
  ...
  editScriptSchema,
} from '../../shared/types/edit-script.types';
    ...
    (data: EditScriptFormData) => {
      ...
      if (isEditMode && scriptId) {
        commitUpdate({
          ...
          onCompleted: () => {
            ...
            safeBackOrReplace(router, routes.scripts.details(scriptId));
          },
          onError: err => {
            toast({
              title: 'Error',
      ...
      commitCreate({
        ...
        onCompleted: response => {
          ...
          router.replace(newId ? routes.scripts.details(newId) : routes.scripts.list);
        },
        onError: err => {
          toast({
            title: 'Error',
