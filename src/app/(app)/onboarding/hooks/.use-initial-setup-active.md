...
|--------|------|-------------|
| `useInitialSetupActive` | `() => boolean` | React hook returning `true` only when all three conditions are met: store loaded, tenant record exists (non-null), and onboarding not yet completed |
