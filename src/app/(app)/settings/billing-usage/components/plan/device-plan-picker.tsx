...
import { BillingRow } from '../shared/billing-section';
import type { DevicePlanMode, ProductUpdates } from './plan-selection';
import { QuantityStepper } from './quantity-stepper';
import { useDevicePlanSelection } from './use-device-plan-selection';

/**
 * The picker reads nothing of its own: everything it draws comes back from
 * `useDevicePlanSelection`, so the fragments here are the hook's, spread by the
...
export const devicePlanPickerProductFragment = graphql`
  fragment devicePlanPickerProductFragment on Product {
    ...useDevicePlanSelection_product
  }
`;
...
export const devicePlanPickerSubscriptionFragment = graphql`
  fragment devicePlanPickerSubscriptionFragment on SubscriptionProductDetail {
    ...useDevicePlanSelection_subscriptionProduct
  }
`;
...
export function DevicePlanPicker({
  ...
  const {
    ...
    setQuantity,
    commitQuantity,
  } = useDevicePlanSelection({ productRef: product, subscriptionProductRef: subscriptionProduct, onUpdatesChange });
